...
int xpthread_join(
    pthread_t thread, void **retval, int linea, const char *file
) {
...
// mutex
int xpthread_mutex_init(
    pthread_mutex_t *mutex, const pthread_mutexattr_t *attr, int linea,
    const char *file
) {
...
int xpthread_mutex_destroy(
    pthread_mutex_t *mutex, int linea, const char *file
) {
...
// semaphores
int xsem_init(
    sem_t *sem, int pshared, unsigned int value, int linea, const char *file
) {
